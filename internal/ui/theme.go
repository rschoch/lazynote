...
func builtInThemes() map[string]Theme {
	return map[string]Theme{
		"default": {
			...
			ActiveBorder:   gocui.GetRGBColor(0x3a6ea5) | gocui.AttrBold,
			InactiveBorder: gocui.ColorDefault | gocui.AttrDim,
			Title:          gocui.GetRGBColor(0x3a6ea5) | gocui.AttrBold,
			Warning:        gocui.ColorDefault | gocui.AttrBold,
			StatusFg:       gocui.ColorDefault,
			SelectedLineBg: gocui.GetRGBColor(0x3a6ea5),
			SelectedLineFg: gocui.GetRGBColor(0xffffff),
		},
		"dark": {
			Name:           "dark",
			DefaultBg:      gocui.Get256Color(234),
		...
		"light": {
			Name:           "light",
			DefaultBg:      gocui.GetRGBColor(0xf8fafc),
			DefaultFg:      gocui.GetRGBColor(0x1f2937),
			MutedFg:        gocui.GetRGBColor(0x6b7280),
			ActiveBorder:   gocui.GetRGBColor(0x2563eb) | gocui.AttrBold,
			InactiveBorder: gocui.GetRGBColor(0xd1d5db),
			Title:          gocui.GetRGBColor(0x7c3aed) | gocui.AttrBold,
			Warning:        gocui.GetRGBColor(0xb45309) | gocui.AttrBold,
			StatusFg:       gocui.GetRGBColor(0x4b5563),
			SelectedLineBg: gocui.GetRGBColor(0xdbeafe),
			SelectedLineFg: gocui.GetRGBColor(0x111827) | gocui.AttrBold,
		},
		"high-contrast": {
			Name:           "high-contrast",
			DefaultBg:      gocui.ColorDefault,
			DefaultFg:      gocui.ColorDefault,
			MutedFg:        gocui.ColorDefault,
			ActiveBorder:   gocui.ColorDefault | gocui.AttrReverse,
			InactiveBorder: gocui.ColorDefault,
			Title:          gocui.ColorDefault | gocui.AttrBold | gocui.AttrUnderline,
			Warning:        gocui.ColorDefault | gocui.AttrBold | gocui.AttrReverse,
			StatusFg:       gocui.ColorDefault,
			SelectedLineBg: gocui.ColorDefault | gocui.AttrReverse,
			SelectedLineFg: gocui.ColorDefault | gocui.AttrBold,
		},
		"mono": {
			Name:           "mono",
			DefaultBg:      gocui.ColorDefault,
